...
import {clockTick, setAlarmTime, snoozeAlarm} from "../actions/_collection"
...
const alarmSetTime = moment("2017-11-16").add(7, "hours").add(15, "minutes")
